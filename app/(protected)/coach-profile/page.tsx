...
export default function CoachProfilePage() {
    ...
    useEffect(() => {
        ...
        const fetchProfile = async () => {
            try {
                if (user.role !== "COACH") {
                    setError("Only coaches can view this page.");
                    return;
                }
                    ...
                    <div className="flex flex-wrap items-start justify-between gap-4">
                        <div>
                            ...
                            <p className="mt-3 max-w-2xl text-stone-400">
                                Your public coaching identity. Let players see who is behind the
                                plan and keep your profile ready for new connections.
                            </p>
                        </div>
