  ...
  useEffect(() => {
    ...
    const loadSessions = async () => {
      try {
        ...
        console.error(err);
        setSessions([]);
        setError("Failed to load player sessions for this date.");
      } finally {
        setLoading(false);
      }
    };
      ...
      <section className="rounded-[2rem] border border-zinc-800 bg-linear-to-br from-zinc-900 to-zinc-950 p-8 shadow-2xl shadow-black/20">
        <div className="flex flex-wrap items-start justify-between gap-6">
          <div className="max-w-2xl">
            ...
            <h1 className="mt-3 text-4xl font-black text-stone-100">Coach Calendar</h1>
      ...
      <section className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-stone-400">
              {sessions.length === 0
                ? "No player sessions were recorded on this date."
        ...
        {sessions.length === 0 ? (
          <div className="mt-6 rounded-2xl border border-dashed border-zinc-700 bg-zinc-950/60 p-8 text-stone-500">
            None of your players logged a session on this date.
          </div>
        ) : (
